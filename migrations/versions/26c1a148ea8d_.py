...
Revision ID: 26c1a148ea8d
Revises: 
Create Date: 2024-03-24 22:43:46.148352
...
def upgrade_():
    ...
    sa.ForeignKeyConstraint(['league_id'], ['league.id'], ),
    sa.ForeignKeyConstraint(['match_type_id'], ['matchtype.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['first_season_id'], ['season_division.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.ForeignKeyConstraint(['final_id'], ['final.id'], ),
    sa.ForeignKeyConstraint(['loser_id'], ['team.id'], ),
    ...
    sa.ForeignKeyConstraint(['home_team_id'], ['team.id'], ),
    sa.ForeignKeyConstraint(['season_division_id'], ['season_division.id'], ),
    sa.ForeignKeyConstraint(['streamer_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
